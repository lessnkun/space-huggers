...
function explosion(pos, radius=2, damageTeam=team_none)
{
    ...
    forEachObject(pos, radius*3, (o)=> 
    {
        ...
        if (o.isGameObject)
        {
            const isFriendly = damageTeam != team_none && o.team == damageTeam;

            // do damage
            d < radius && !isFriendly && o.damage(damage);

            // catch fire
            d < radius*1.5 && !isFriendly && o.burn();
        }
